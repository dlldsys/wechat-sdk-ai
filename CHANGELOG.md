...
### Fixed
- Improved FileCache error handling in cleanup process
- Added token generation support to MemoryLock for better security
- Added author information to package.json

### Changed
- Updated MemoryLock to use unique token per lock acquisition
